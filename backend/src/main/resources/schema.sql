...
CREATE TABLE IF NOT EXISTS ve_xe (
    ...
    thoi_gian_hoan DATETIME NULL,
    thoi_gian_yeu_cau_hoan DATETIME NULL,
    stk_hoan VARCHAR(32) NULL,
    ten_ngan_hang_hoan VARCHAR(128) NULL,
    ten_nguoi_nhan_hoan VARCHAR(128) NULL,
