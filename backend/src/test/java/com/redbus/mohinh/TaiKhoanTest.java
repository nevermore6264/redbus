...
@DisplayName("TaiKhoan - khoi tao va thuoc tinh (1000 case)")
class TaiKhoanTest {

    @ParameterizedTest(name = "case {0}: tao instance TaiKhoan va toString khong null")
