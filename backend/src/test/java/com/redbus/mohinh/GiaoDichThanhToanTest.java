...
@DisplayName("GiaoDichThanhToan - khoi tao va thuoc tinh (1000 case)")
class GiaoDichThanhToanTest {

    @ParameterizedTest(name = "case {0}: tao instance GiaoDichThanhToan va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = GiaoDichThanhToan.class;
        try {
