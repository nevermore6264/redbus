...
@DisplayName("XeKhach - khoi tao va thuoc tinh (1000 case)")
class XeKhachTest {

    @ParameterizedTest(name = "case {0}: tao instance XeKhach va toString khong null")
