...
@DisplayName("AnhLoaiXe - khoi tao va thuoc tinh (1000 case)")
class AnhLoaiXeTest {

    @ParameterizedTest(name = "case {0}: tao instance AnhLoaiXe va toString khong null")
