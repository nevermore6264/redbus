...
@DisplayName("DanhGiaChuyen - khoi tao va thuoc tinh (1000 case)")
class DanhGiaChuyenTest {

    @ParameterizedTest(name = "case {0}: tao instance DanhGiaChuyen va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = DanhGiaChuyen.class;
        try {
