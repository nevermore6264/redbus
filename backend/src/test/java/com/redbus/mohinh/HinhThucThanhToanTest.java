...
@DisplayName("HinhThucThanhToan - khoi tao va thuoc tinh (1000 case)")
class HinhThucThanhToanTest {

    @ParameterizedTest(name = "case {0}: tao instance HinhThucThanhToan va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = HinhThucThanhToan.class;
        try {
