...
@DisplayName("ChuyenXe - khoi tao va thuoc tinh (1000 case)")
class ChuyenXeTest {

    @ParameterizedTest(name = "case {0}: tao instance ChuyenXe va toString khong null")
