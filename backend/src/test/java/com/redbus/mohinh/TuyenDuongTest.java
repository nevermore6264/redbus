...
@DisplayName("TuyenDuong - khoi tao va thuoc tinh (1000 case)")
class TuyenDuongTest {

    @ParameterizedTest(name = "case {0}: tao instance TuyenDuong va toString khong null")
