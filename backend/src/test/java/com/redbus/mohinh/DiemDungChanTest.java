...
@DisplayName("DiemDungChan - khoi tao va thuoc tinh (1000 case)")
class DiemDungChanTest {

    @ParameterizedTest(name = "case {0}: tao instance DiemDungChan va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = DiemDungChan.class;
        try {
