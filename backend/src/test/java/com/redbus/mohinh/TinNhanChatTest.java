...
@DisplayName("TinNhanChat - khoi tao va thuoc tinh (1000 case)")
class TinNhanChatTest {

    @ParameterizedTest(name = "case {0}: tao instance TinNhanChat va toString khong null")
