...
@DisplayName("KhuyenMai - khoi tao va thuoc tinh (1000 case)")
class KhuyenMaiTest {

    @ParameterizedTest(name = "case {0}: tao instance KhuyenMai va toString khong null")
