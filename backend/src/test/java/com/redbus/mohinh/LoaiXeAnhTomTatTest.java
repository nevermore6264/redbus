...
@DisplayName("LoaiXeAnhTomTat - khoi tao va thuoc tinh (1000 case)")
class LoaiXeAnhTomTatTest {

    @ParameterizedTest(name = "case {0}: tao instance LoaiXeAnhTomTat va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = LoaiXeAnhTomTat.class;
        try {
