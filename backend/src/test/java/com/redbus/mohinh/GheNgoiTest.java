...
@DisplayName("GheNgoi - khoi tao va thuoc tinh (1000 case)")
class GheNgoiTest {

    @ParameterizedTest(name = "case {0}: tao instance GheNgoi va toString khong null")
