...
@DisplayName("ThongBao - khoi tao va thuoc tinh (1000 case)")
class ThongBaoTest {

    @ParameterizedTest(name = "case {0}: tao instance ThongBao va toString khong null")
