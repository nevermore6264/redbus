...
@DisplayName("YeuCauDangNhap - khoi tao va thuoc tinh (1000 case)")
class YeuCauDangNhapTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauDangNhap va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauDangNhap.class;
        try {
