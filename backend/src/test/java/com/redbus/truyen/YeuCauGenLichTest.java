...
@DisplayName("YeuCauGenLich - khoi tao va thuoc tinh (1000 case)")
class YeuCauGenLichTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauGenLich va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauGenLich.class;
        try {
