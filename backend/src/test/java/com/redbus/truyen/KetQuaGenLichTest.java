...
@DisplayName("KetQuaGenLich - khoi tao va thuoc tinh (1000 case)")
class KetQuaGenLichTest {

    @ParameterizedTest(name = "case {0}: tao instance KetQuaGenLich va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = KetQuaGenLich.class;
        try {
