...
@DisplayName("PhanHoiLinkPayOs - khoi tao va thuoc tinh (1000 case)")
class PhanHoiLinkPayOsTest {

    @ParameterizedTest(name = "case {0}: tao instance PhanHoiLinkPayOs va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = PhanHoiLinkPayOs.class;
        try {
