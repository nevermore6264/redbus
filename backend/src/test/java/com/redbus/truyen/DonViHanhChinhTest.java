...
@DisplayName("DonViHanhChinh - khoi tao va thuoc tinh (1000 case)")
class DonViHanhChinhTest {

    @ParameterizedTest(name = "case {0}: tao instance DonViHanhChinh va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = DonViHanhChinh.class;
        try {
