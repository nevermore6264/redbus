...
@DisplayName("YeuCauCapNhatTrangThaiGhe - khoi tao va thuoc tinh (1000 case)")
class YeuCauCapNhatTrangThaiGheTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauCapNhatTrangThaiGhe va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauCapNhatTrangThaiGhe.class;
        try {
