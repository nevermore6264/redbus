...
@DisplayName("YeuCauCapNhatHoSo - khoi tao va thuoc tinh (1000 case)")
class YeuCauCapNhatHoSoTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauCapNhatHoSo va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauCapNhatHoSo.class;
        try {
