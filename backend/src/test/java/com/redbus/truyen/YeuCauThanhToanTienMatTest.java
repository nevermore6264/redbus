...
@DisplayName("YeuCauThanhToanTienMat - khoi tao va thuoc tinh (1000 case)")
class YeuCauThanhToanTienMatTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauThanhToanTienMat va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauThanhToanTienMat.class;
        try {
