...
@DisplayName("YeuCauThemKhachQuanTri - khoi tao va thuoc tinh (1000 case)")
class YeuCauThemKhachQuanTriTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauThemKhachQuanTri va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauThemKhachQuanTri.class;
        try {
