...
@DisplayName("ThongTinHoSoCaNhan - khoi tao va thuoc tinh (1000 case)")
class ThongTinHoSoCaNhanTest {

    @ParameterizedTest(name = "case {0}: tao instance ThongTinHoSoCaNhan va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = ThongTinHoSoCaNhan.class;
        try {
