...
@DisplayName("DanhGiaCongKhaiPhanHoi - khoi tao va thuoc tinh (1000 case)")
class DanhGiaCongKhaiPhanHoiTest {

    @ParameterizedTest(name = "case {0}: tao instance DanhGiaCongKhaiPhanHoi va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = DanhGiaCongKhaiPhanHoi.class;
        try {
