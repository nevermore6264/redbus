...
@DisplayName("AnhLoaiXePhanHoi - khoi tao va thuoc tinh (1000 case)")
class AnhLoaiXePhanHoiTest {

    @ParameterizedTest(name = "case {0}: tao instance AnhLoaiXePhanHoi va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = AnhLoaiXePhanHoi.class;
        try {
