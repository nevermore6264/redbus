...
@DisplayName("BaoCaoMoRong - khoi tao va thuoc tinh (1000 case)")
class BaoCaoMoRongTest {

    @ParameterizedTest(name = "case {0}: tao instance BaoCaoMoRong va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = BaoCaoMoRong.class;
        try {
