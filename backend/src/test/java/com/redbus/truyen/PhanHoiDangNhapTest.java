...
@DisplayName("PhanHoiDangNhap - khoi tao va thuoc tinh (1000 case)")
class PhanHoiDangNhapTest {

    @ParameterizedTest(name = "case {0}: tao instance PhanHoiDangNhap va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = PhanHoiDangNhap.class;
        try {
