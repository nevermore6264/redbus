...
@DisplayName("YeuCauDatVe - khoi tao va thuoc tinh (1000 case)")
class YeuCauDatVeTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauDatVe va toString khong null")
