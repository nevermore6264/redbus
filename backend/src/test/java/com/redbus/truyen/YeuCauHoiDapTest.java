...
@DisplayName("YeuCauHoiDap - khoi tao va thuoc tinh (1000 case)")
class YeuCauHoiDapTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauHoiDap va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauHoiDap.class;
        try {
