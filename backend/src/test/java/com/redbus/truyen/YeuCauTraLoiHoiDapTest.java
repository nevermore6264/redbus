...
@DisplayName("YeuCauTraLoiHoiDap - khoi tao va thuoc tinh (1000 case)")
class YeuCauTraLoiHoiDapTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauTraLoiHoiDap va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauTraLoiHoiDap.class;
        try {
