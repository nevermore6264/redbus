...
@DisplayName("ThongTinKhachHangPhanHoi - khoi tao va thuoc tinh (1000 case)")
class ThongTinKhachHangPhanHoiTest {

    @ParameterizedTest(name = "case {0}: tao instance ThongTinKhachHangPhanHoi va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = ThongTinKhachHangPhanHoi.class;
        try {
