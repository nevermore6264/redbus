...
@DisplayName("YeuCauDanhGiaChuyen - khoi tao va thuoc tinh (1000 case)")
class YeuCauDanhGiaChuyenTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauDanhGiaChuyen va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauDanhGiaChuyen.class;
        try {
