...
@DisplayName("YeuCauDangKy - khoi tao va thuoc tinh (1000 case)")
class YeuCauDangKyTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauDangKy va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauDangKy.class;
        try {
