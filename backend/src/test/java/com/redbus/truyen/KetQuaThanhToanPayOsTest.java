...
@DisplayName("KetQuaThanhToanPayOs - khoi tao va thuoc tinh (1000 case)")
class KetQuaThanhToanPayOsTest {

    @ParameterizedTest(name = "case {0}: tao instance KetQuaThanhToanPayOs va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = KetQuaThanhToanPayOs.class;
        try {
