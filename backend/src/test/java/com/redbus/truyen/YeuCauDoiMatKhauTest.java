...
@DisplayName("YeuCauDoiMatKhau - khoi tao va thuoc tinh (1000 case)")
class YeuCauDoiMatKhauTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauDoiMatKhau va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauDoiMatKhau.class;
        try {
