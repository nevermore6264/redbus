...
@DisplayName("YeuCauGuiChat - khoi tao va thuoc tinh (1000 case)")
class YeuCauGuiChatTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauGuiChat va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauGuiChat.class;
        try {
