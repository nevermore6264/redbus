...
@DisplayName("YeuCauCapNhatKhachQuanTri - khoi tao va thuoc tinh (1000 case)")
class YeuCauCapNhatKhachQuanTriTest {

    @ParameterizedTest(name = "case {0}: tao instance YeuCauCapNhatKhachQuanTri va toString khong null")
    ...
    private static Object taoInstance(int chiSo) throws Exception {
        Class<?> clazz = YeuCauCapNhatKhachQuanTri.class;
        try {
